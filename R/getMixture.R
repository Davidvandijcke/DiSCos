...
#' @description Compute the Wasserstein barycenter of a set of distributions
#' @param controls1 List with matrices of control distributions.
#' @param target Vector of observations for the target unit.
