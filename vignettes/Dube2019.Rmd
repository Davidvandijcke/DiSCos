...
```{r}
disco <- DiSCo(dube, id_col.target=id_col.target, t0=t0, G = 250, num.cores = 1, permutation = TRUE, CI = TRUE, boots = 1000, graph = FALSE, q_min = 0.7, q_max=0.95, seed=1, simplex=TRUE)
```
